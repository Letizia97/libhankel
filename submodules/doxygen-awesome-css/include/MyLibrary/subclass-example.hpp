...
template <typename TemplatedClass> class SubclassExample : public Example {
  public:
     ...
     */
    template <typename T, typename Foo, typename Bar, typename Alice, typename Bob,
              typename Charlie, typename Hello, typename World>
    std::pair<std::string, std::string>
    long_function_with_many_parameters(std::shared_ptr<T> &param1,
                                       std::shared_ptr<std::string> &param2, bool parameter3,

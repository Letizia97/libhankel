...
result = libhankel.hankel_transform(nu, dab, x_arr, params_gdab, "QWE_Chave", strategy_p_dict)

print(
    "Result of calling the hankel_transform with a user-defined python function \n",
    result,
)
